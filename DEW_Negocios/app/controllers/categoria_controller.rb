class CategoriaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categorium.save
        format.html { redirect_to @categorium, notice: 'Se ha creado la categoria satisfactoriamente.' }
  ...
  def update
    ...
    respond_to do |format|
      if @categorium.update_attributes(params[:categorium])
        format.html { redirect_to @categorium, notice: 'Se ha actualizado la categoria satisfactoriamente.' }
