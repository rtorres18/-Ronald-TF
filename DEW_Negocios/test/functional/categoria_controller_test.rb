...
class CategoriaControllerTest < ActionController::TestCase
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post :create, categorium: { codcategoria: @categorium.codcategoria, nombrecategoria: @categorium.nombrecategoria }
    end
  ...
  test "should update categorium" do
    put :update, id: @categorium, categorium: { codcategoria: @categorium.codcategoria, nombrecategoria: @categorium.nombrecategoria }
    assert_redirected_to categorium_path(assigns(:categorium))
  end
