...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { pregunta: @faq.pregunta, respuesta: @faq.respuesta, satisfactorio: @faq.satisfactorio }
    end
  ...
  test "should update faq" do
    put :update, id: @faq, faq: { pregunta: @faq.pregunta, respuesta: @faq.respuesta, satisfactorio: @faq.satisfactorio }
    assert_redirected_to faq_path(assigns(:faq))
  end
